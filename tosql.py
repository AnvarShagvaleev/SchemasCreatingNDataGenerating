...
categories = pd.read_excel('NewDataFull.xlsx', sheet_name='sr.1') 
products = pd.read_excel('NewDataFull.xlsx', sheet_name='sr.2', index_col='id')
sells = pd.read_excel('NewDataFull.xlsx', sheet_name='sr.3', index_col='id')
suppliers = pd.read_excel('NewDataFull.xlsx', sheet_name='sr.4', index_col='id')
# sup_to_prod = pd.read_excel('NewDataFull.xlsx', sheet_name='sr.5', index_col='id')
